...
from acmedeliver import schemas
...
class AcmedeliverException(Exception):
    ...
    @classmethod
    def to_model(cls) -> schemas.error.AcmedeliverErrorModel:
        return schemas.error.AcmedeliverErrorModel(error_code=cls.ERROR_CODE, reason=cls.REASON)
