...
class AcmegeolocateException(Exception):
    STATUS_CODE: int = 500
...
class MissingAuthHeader(AcmegeolocateException):
    STATUS_CODE = 401
    ERROR_CODE = "MISSING_AUTH_HEADER"
    REASON = "The Authorization header is missing."


class InvalidAuthHeader(AcmegeolocateException):
    STATUS_CODE = 401
    ERROR_CODE = "INVALID_AUTH_HEADER"
    REASON = "The provided Authorization header is invalid."


class WrongAuthHeader(AcmegeolocateException):
    STATUS_CODE = 401
