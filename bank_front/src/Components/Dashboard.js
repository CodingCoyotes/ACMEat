...
export default function Dashboard() {
    ...
    async function report() {
        ...
        let message_element = xmlDoc.getElementsByTagName("message")
        console.debug(message_element.item(0).innerHTML.split("\n"))
        setTransactions(message_element.item(0).innerHTML.split("\n"))
    }
