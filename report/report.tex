...
\begin{lstlisting}[caption=Proiezione della coerografia relativamente alla banca, escapeinside={(*@}{@*)}]
Coreografia :== (
	ModificaInformazioniLocali |
	CoreografiaOrdine
)
...
\begin{figure}[!ht]
\begin{center}
\fbox{\includegraphics[width=\textwidth]{bpmn1}}
...
\begin{figure}[!ht]
\begin{center}
\fbox{\includegraphics[width=\textwidth]{bpmn2}}
...
\begin{figure}[H]
\begin{center}
\fbox{\includegraphics[width=\textwidth]{er_acmeat}}
